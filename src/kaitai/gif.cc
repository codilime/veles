...
gif_t::gif_t(kaitai::kstream *p_io, kaitai::kstruct *p_parent, gif_t *p_root) : kaitai::kstruct(p_io) {
    ...
    m_logical_screen_descriptor = new logical_screen_descriptor_t(m__io, this, m__root);
    m__io->popName();
...
gif_t::global_color_table_t::global_color_table_t(kaitai::kstream *p_io, gif_t *p_parent, gif_t *p_root) : kaitai::kstruct(p_io) {
    m__io->pushName("_parent");
    m__parent = p_parent;
    m__io->popName();
    m__io->pushName("_root");
...
gif_t::color_table_entry_t::color_table_entry_t(kaitai::kstream *p_io, gif_t::global_color_table_t *p_parent, gif_t *p_root) : kaitai::kstruct(p_io) {
    m__io->pushName("_parent");
    m__parent = p_parent;
    m__io->popName();
    m__io->pushName("_root");
...
gif_t::logical_screen_descriptor_t::logical_screen_descriptor_t(kaitai::kstream *p_io, gif_t *p_parent, gif_t *p_root) : kaitai::kstruct(p_io) {
    m__io->pushName("_parent");
    m__parent = p_parent;
    m__io->popName();
    m__io->pushName("_root");
