...
set(ZLIB_INCLUDES "${ZLIB_INCLUDE_DIR}/zconf.h" "${ZLIB_INCLUDE_DIR}/zlib.h")

if(MSVC)
    set(ZLIB_LIBRARY ${zlib_install}/lib/zlibstatic$<$<CONFIG:Debug>:d>.lib)
endif(MSVC)
if(MINGW)
  set(ZLIB_LIBRARY "${zlib_install}/lib/libzlibstatic.a")
endif(MINGW)
if(UNIX)
