...
// this depends on file generated by veles compile so it needs to be run after ubuntu-16.04
stage 'python ubuntu 16.04'
if (platforms == 'all' || platforms == 'ubuntu-16.04'){
  test_python()
}
