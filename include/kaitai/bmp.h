...
public:
    ...
    public:
        ...
        bmp_t* _root() const { return m__root; }
        bmp_t* _parent() const { return m__parent; }
        std::vector<uint8_t> _skip_me_bitmap_core_header() const { return m__skip_me_bitmap_core_header; }
        kaitai::kstream* _io__skip_me_bitmap_core_header() const { return m__io__skip_me_bitmap_core_header; }
        std::vector<uint8_t> _skip_me_bitmap_info_header() const { return m__skip_me_bitmap_info_header; }
        kaitai::kstream* _io__skip_me_bitmap_info_header() const { return m__io__skip_me_bitmap_info_header; }
        std::vector<uint8_t> _skip_me_bitmap_v5_header() const { return m__skip_me_bitmap_v5_header; }
        kaitai::kstream* _io__skip_me_bitmap_v5_header() const { return m__io__skip_me_bitmap_v5_header; }
    };
