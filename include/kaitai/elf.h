...
public:
    ...
    public:
        ...
        file_header_t(kaitai::kstream* p_io, elf_t* p_parent = 0, elf_t* p_root = 0);
        veles::dbif::ObjectHandle veles_obj;
        ~file_header_t();
    ...
    public:
        ...
        /**
         * File class: designates target machine word size (32 or 64 bits). The size of many integer fields in this format will depend on this setting.
    ...
    public:
        ...
        program_header_t(kaitai::kstream* p_io, elf_t* p_parent = 0, elf_t* p_root = 0);
        veles::dbif::ObjectHandle veles_obj;
        ~program_header_t();
    ...
    public:
        ...
        section_header_t(kaitai::kstream* p_io, elf_t* p_parent = 0, elf_t* p_root = 0);
        veles::dbif::ObjectHandle veles_obj;
        ~section_header_t();
...
public:
    ...
    std::vector<std::vector<uint8_t>>* _skip_me_program_headers() const { return m__skip_me_program_headers; }
    kaitai::kstream* _io__skip_me_program_headers() const { return m__io__skip_me_program_headers; }
    std::vector<std::vector<uint8_t>>* _skip_me_section_headers() const { return m__skip_me_section_headers; }
    kaitai::kstream* _io__skip_me_section_headers() const { return m__io__skip_me_section_headers; }
