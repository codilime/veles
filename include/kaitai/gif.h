...
public:
    ...
    public:
        ...
        global_color_table_t(kaitai::kstream* p_io, gif_t* p_parent = 0, gif_t* p_root = 0);
        veles::dbif::ObjectHandle veles_obj;
    ...
    public:
        ...
        color_table_entry_t(kaitai::kstream* p_io, gif_t::global_color_table_t* p_parent = 0, gif_t* p_root = 0);
        veles::dbif::ObjectHandle veles_obj;
        ~color_table_entry_t();
    ...
    public:
        ...
        logical_screen_descriptor_t(kaitai::kstream* p_io, gif_t* p_parent = 0, gif_t* p_root = 0);
        veles::dbif::ObjectHandle veles_obj;
...
public:
    ...
    logical_screen_descriptor_t* logical_screen_descriptor() const { return m_logical_screen_descriptor; }
    global_color_table_t* global_color_table() const { return m_global_color_table; }
    std::vector<block_t*>* blocks() const { return m_blocks; }
    gif_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
    std::vector<uint8_t> _skip_me_global_color_table() const { return m__skip_me_global_color_table; }
