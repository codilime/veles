...
public:
    ...
    public:
        bool _is_null_image_base() { image_base(); return n_image_base; };
    ...
    public:
        bool _is_null_image_base2() { image_base2(); return n_image_base2; };
    ...
    public:
        bool _is_null_size_of_stack_reserve() { size_of_stack_reserve(); return n_size_of_stack_reserve; };
    ...
    public:
        bool _is_null_size_of_stack_reserve2() { size_of_stack_reserve2(); return n_size_of_stack_reserve2; };
    ...
    public:
        bool _is_null_size_of_stack_commit() { size_of_stack_commit(); return n_size_of_stack_commit; };
    ...
    public:
        bool _is_null_size_of_stack_commit2() { size_of_stack_commit2(); return n_size_of_stack_commit2; };
    ...
    public:
        bool _is_null_size_of_heap_reserve() { size_of_heap_reserve(); return n_size_of_heap_reserve; };
    ...
    public:
        bool _is_null_size_of_heap_reserve2() { size_of_heap_reserve2(); return n_size_of_heap_reserve2; };
    ...
    public:
        bool _is_null_size_of_heap_commit() { size_of_heap_commit(); return n_size_of_heap_commit; };
    ...
    public:
        bool _is_null_size_of_heap_commit2() { size_of_heap_commit2(); return n_size_of_heap_commit2; };
...
public:
    ...
    std::vector<uint8_t> _skip_me_optional_header() const { return m__skip_me_optional_header; }
