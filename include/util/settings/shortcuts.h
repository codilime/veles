...
enum ShortcutType : uint32_t {
  ...
  COPY = 38,
  HEX_MOVE_TO_NEXT_CHAR = 39,
  HEX_MOVE_TO_PREV_CHAR = 40,
  HEX_MOVE_TO_NEXT_LINE = 41,
  HEX_MOVE_TO_PREV_LINE = 42,
  HEX_MOVE_TO_NEXT_PAGE = 43,
  HEX_MOVE_TO_PREV_PAGE = 44,
  HEX_MOVE_TO_START_OF_LINE = 45,
  HEX_MOVE_TO_END_OF_LINE = 46,
  HEX_MOVE_TO_START_OF_FILE = 47,
  HEX_MOVE_TO_END_OF_FILE = 48,
  HEX_REMOVE_SELECTION = 49,
  HEX_SELECT_ALL = 50,
  HEX_SELECT_NEXT_CHAR = 51,
  HEX_SELECT_PREV_CHAR = 52,
  HEX_SELECT_NEXT_LINE = 53,
  HEX_SELECT_PREV_LINE = 54,
  HEX_SELECT_NEXT_PAGE = 55,
  HEX_SELECT_PREV_PAGE = 56,
  HEX_SELECT_START_OF_LINE = 57,
  HEX_SELECT_END_OF_LINE = 58,
  HEX_SELECT_START_OF_DOCUMENT = 59,
  HEX_SELECT_END_OF_DOCUMENT = 60,
};
